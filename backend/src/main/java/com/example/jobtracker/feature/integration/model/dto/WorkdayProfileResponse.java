...
/**
 * Response DTO for reusable job-form autofill profile data.
 * Mirrors saved profile fields and tells the frontend whether anything is configured.
 */
public class WorkdayProfileResponse {
    /** True when at least one autofill profile field has been saved. */
